...
export default function Project2() {
  return (
     <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-8 md:space-y-0">
          {/* Right: Project Image */}
          ...
          <div className="w-full md:w-3/4">
            ...
            <div className="mt-8">
              ...
              <ul className="flex flex-wrap text-start sm:list-disc sm:pl-6 space-y-2">
                ...
                <li>It provides three distinct roles: Admin, Sender, and Receiver.</li>
                <li>
              ...
              <div className="flex gap-x-6 mt-5">
                <Button className="bg-gradient-to-r rounded-none from-purple-500 to-pink-400">
                  Live link
                </Button>
                <Button className="bg-gradient-to-r rounded-none from-red-500 to-green-600">
                  Live link
                </Button>
              </div>
            </div>
